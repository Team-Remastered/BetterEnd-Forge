...
public class InfusionRecipes {
	public static void register() {
		InfusionRecipe.Builder.create("runed_flavolite")
							  ...
							  .addCatalyst(4, EndItems.CRYSTAL_SHARDS.get())
							  .addCatalyst(6, EndItems.CRYSTAL_SHARDS.get())
							  .setTime(100)
							  .build();
		
		InfusionRecipe.Builder.create("eternal_crystal")
							  .setInput(Items.END_CRYSTAL)
							  .setOutput(EndItems.ETERNAL_CRYSTAL.get())
							  .addCatalyst(0, EndItems.CRYSTAL_SHARDS.get())
							  .addCatalyst(2, EndItems.CRYSTAL_SHARDS.get())
							  .addCatalyst(4, EndItems.CRYSTAL_SHARDS.get())
							  .addCatalyst(6, EndItems.CRYSTAL_SHARDS.get())
							  .addCatalyst(1, EndItems.ENDER_SHARD.get())
							  .addCatalyst(3, EndItems.ENDER_SHARD.get())
							  .addCatalyst(5, EndItems.ENDER_SHARD.get())
							  .addCatalyst(7, EndItems.ENDER_SHARD.get())
							  .setTime(250)
							  .build();
		...
		InfusionRecipe.Builder.create("crystalite_chestplate")
							  ...
							  .addCatalyst(3, EndItems.CRYSTAL_SHARDS.get())
							  .addCatalyst(5, EndItems.CRYSTAL_SHARDS.get())
							  .addCatalyst(7, EndItems.CRYSTAL_SHARDS.get())
							  .setTime(300)
							  .build();
		...
		InfusionRecipe.Builder.create("crystalite_elytra")
							  ...
							  .setOutput(EndItems.CRYSTALITE_ELYTRA.get())
							  .addCatalyst(0, EndItems.AMBER_GEM.get())
							  .addCatalyst(1, EndItems.CRYSTAL_SHARDS.get())
							  .addCatalyst(2, EndItems.ENCHANTED_MEMBRANE.get())
							  .addCatalyst(3, EndItems.CRYSTAL_SHARDS.get())
							  .addCatalyst(4, EndItems.ENCHANTED_MEMBRANE.get())
							  .addCatalyst(5, EndItems.CRYSTAL_SHARDS.get())
							  .addCatalyst(6, EndItems.ENCHANTED_MEMBRANE.get())
							  .addCatalyst(7, EndItems.CRYSTAL_SHARDS.get())
							  .setTime(500)
							  .build();
		
		InfusionRecipe.Builder.create("enchanted_petal")
							  .setInput(EndItems.HYDRALUX_PETAL.get())
							  .setOutput(EndItems.ENCHANTED_PETAL.get())
							  .addCatalyst(0, EndItems.CRYSTAL_SHARDS.get())
							  .addCatalyst(2, EndItems.CRYSTAL_SHARDS.get())
							  .addCatalyst(4, EndItems.CRYSTAL_SHARDS.get())
							  .addCatalyst(6, EndItems.CRYSTAL_SHARDS.get())
		...
		InfusionRecipe.Builder.create("enchanted_membrane")
							  ...
							  .setOutput(EndItems.ENCHANTED_MEMBRANE.get())
							  .addCatalyst(0, EndItems.CRYSTAL_SHARDS.get())
							  .addCatalyst(2, EndItems.CRYSTAL_SHARDS.get())
							  .addCatalyst(4, EndItems.CRYSTAL_SHARDS.get())
							  .addCatalyst(6, EndItems.CRYSTAL_SHARDS.get())
		...
		InfusionRecipe.Builder.create("protection_book")
							  ...
							  .addCatalyst(0, EndItems.ENCHANTED_PETAL.get())
		...
		InfusionRecipe.Builder.create("depth_strider_book")
							  ...
							  .addCatalyst(4, EndBlocks.END_LILY_SEED.get())
		...
		InfusionRecipe.Builder.create("frost_walker_book")
							  ...
							  .addCatalyst(0, EndItems.ENCHANTED_PETAL.get())
							  .addCatalyst(4, EndBlocks.ANCIENT_EMERALD_ICE.get())
							  .addCatalyst(1, Items.LAPIS_LAZULI)
							  .addCatalyst(3, Items.LAPIS_LAZULI)
							  .addCatalyst(5, Items.LAPIS_LAZULI)
							  .addCatalyst(7, Items.LAPIS_LAZULI)
		...
		InfusionRecipe.Builder.create("efficiency_book")
							  ...
							  .addCatalyst(0, EndItems.ENCHANTED_PETAL.get())
							  .addCatalyst(2, EndItems.AMBER_GEM.get())
							  .addCatalyst(4, EndItems.AMBER_GEM.get())
							  .addCatalyst(6, EndItems.AMBER_GEM.get())
							  .addCatalyst(1, Items.LAPIS_LAZULI)
							  .addCatalyst(3, Items.LAPIS_LAZULI)
							  .addCatalyst(5, Items.LAPIS_LAZULI)
							  .addCatalyst(7, Items.LAPIS_LAZULI)
		...
		InfusionRecipe.Builder.create("silk_touch_book")
							  ...
							  .addCatalyst(4, EndItems.ETERNAL_CRYSTAL.get())
