...
import com.teamremastered.betterendforge.bclib.interfaces.TriConsumer;
import net.minecraftforge.api.distmarker.Dist;
import net.minecraftforge.api.distmarker.OnlyIn;
import net.minecraft.client.gui.components.AbstractWidget;
import com.teamremastered.betterendforge.bclib.util.Pair;
...
abstract class GridCellDefinition {
	...
	int calculateWidth(final int parentWidth){
		...
		} else if (widthType == GridLayout.GridValueType.PERCENTAGE) {
	...
	final GridElement buildElement(final int parentWidth, final int autoWidth, final float autoWidthSum, int left, final int top, final List<GridElement> collector) {
		final int width = widthType == GridLayout.GridValueType.FILL ?(int)((this.width/autoWidthSum)*autoWidth):calculateWidth(parentWidth);
