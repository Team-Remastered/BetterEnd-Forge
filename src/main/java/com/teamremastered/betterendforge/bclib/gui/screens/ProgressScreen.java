...
import com.teamremastered.betterendforge.bclib.gui.gridlayout.GridColumn;
import com.teamremastered.betterendforge.bclib.gui.gridlayout.GridCustomRenderCell;
import com.teamremastered.betterendforge.bclib.gui.gridlayout.GridLayout;
import com.teamremastered.betterendforge.bclib.gui.gridlayout.GridMessageCell;
import com.teamremastered.betterendforge.bclib.gui.gridlayout.GridRow;
import com.teamremastered.betterendforge.bclib.gui.gridlayout.GridScreen;
import com.teamremastered.betterendforge.bclib.gui.gridlayout.GridStringCell;
import com.teamremastered.betterendforge.bclib.gui.gridlayout.GridTransform;
...
public class ProgressScreen extends GridScreen implements ProgressListener, AtomicProgressListener {
	...
	protected void initLayout() {
		...
		progress = textCol.addRow().addString(getProgressComponent(), GridLayout.COLOR_GRAY, GridLayout.Alignment.LEFT, this);
		
		row.addFiller();
		
		grid.addSpacerRow(20);
		row = grid.addRow();
		stage = row.addMessage(stageComponent!=null?stageComponent:new TextComponent(""), font, GridLayout.Alignment.CENTER);
	}
