...
public class EndBiomeCreator {
    ...
    public static Biome AmberLandBiome() {
        ...
        spawnSettings.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.ENDERMAN, 50, 1, 4));
        spawnSettings.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EndEntities.END_SLIME.get(), 30, 1, 2));
    ...
    public static Biome BlossomingSpiresBiome() {
        ...
        BiomeGenerationSettings.Builder generationSettings = new BiomeGenerationSettings.Builder();
        spawnSettings.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.ENDERMAN, 50, 1, 4));
        spawnSettings.addSpawn(MobCategory.AMBIENT, new MobSpawnSettings.SpawnerData(EndEntities.SILK_MOTH.get(), 5, 1, 2));
    ...
    public static Biome ChorusForestBiome() {
        ...
        BiomeGenerationSettings.Builder generationSettings = new BiomeGenerationSettings.Builder();
        spawnSettings.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.ENDERMAN, 50, 1, 4));
        spawnSettings.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EndEntities.END_SLIME.get(), 5, 1, 2));
        return new Biome.BiomeBuilder()
                .specialEffects((new BiomeSpecialEffects.Builder())
    ...
    public static Biome CrystalMountains() {
        MobSpawnSettings.Builder spawnSettings = new MobSpawnSettings.Builder();
        BiomeGenerationSettings.Builder generationSettings = new BiomeGenerationSettings.Builder();
        spawnSettings.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.ENDERMAN, 50, 1, 2));
        return new Biome.BiomeBuilder()
                .specialEffects((new BiomeSpecialEffects.Builder())
    ...
    public static Biome FoggyMushroomlandBiome() {
        MobSpawnSettings.Builder spawnSettings = new MobSpawnSettings.Builder();
        BiomeGenerationSettings.Builder generationSettings = new BiomeGenerationSettings.Builder();
        spawnSettings.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.ENDERMAN, 10, 1, 2));
        spawnSettings.addSpawn(MobCategory.AMBIENT, new MobSpawnSettings.SpawnerData(EndEntities.DRAGONFLY.get(), 80, 2, 5));
        spawnSettings.addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(EndEntities.END_FISH.get(), 20, 2, 5));
        spawnSettings.addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(EndEntities.CUBOZOA.get(), 10, 3, 8));
        spawnSettings.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EndEntities.END_SLIME.get(), 10, 1, 2));
        return new Biome.BiomeBuilder()
                .specialEffects((new BiomeSpecialEffects.Builder())
    ...
    public static Biome MegalakeBiome() {
        ...
        BiomeGenerationSettings.Builder generationSettings = new BiomeGenerationSettings.Builder();
        spawnSettings.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.ENDERMAN, 10, 1, 2));
        spawnSettings.addSpawn(MobCategory.AMBIENT, new MobSpawnSettings.SpawnerData(EndEntities.DRAGONFLY.get(), 50, 2, 3));
        spawnSettings.addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(EndEntities.END_FISH.get(), 50, 3, 8));
        spawnSettings.addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(EndEntities.CUBOZOA.get(), 50, 3, 8));
        spawnSettings.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EndEntities.END_SLIME.get(), 5, 1, 2));
        return new Biome.BiomeBuilder()
                .specialEffects((new BiomeSpecialEffects.Builder())
...
//              .terrainHeight(0F) //need to find a way to change the terrain height
    ...
    public static Biome MegalakeGroveBiome() {
        ...
        BiomeGenerationSettings.Builder generationSettings = new BiomeGenerationSettings.Builder();
        spawnSettings.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.ENDERMAN, 10, 1, 2));
        spawnSettings.addSpawn(MobCategory.AMBIENT, new MobSpawnSettings.SpawnerData(EndEntities.DRAGONFLY.get(), 20, 1, 3));
        spawnSettings.addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(EndEntities.END_FISH.get(), 20, 3, 8));
        spawnSettings.addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(EndEntities.CUBOZOA.get(), 50, 3, 8));
        spawnSettings.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EndEntities.END_SLIME.get(), 5, 1, 2));
        return new Biome.BiomeBuilder()
                .specialEffects((new BiomeSpecialEffects.Builder())
...
//              .terrainHeight(0F)
    ...
    public static Biome ShadowForestBiome() {
        MobSpawnSettings.Builder spawnSettings = new MobSpawnSettings.Builder();
        BiomeGenerationSettings.Builder generationSettings = new BiomeGenerationSettings.Builder();
        spawnSettings.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.ENDERMAN, 40, 1, 4));
        spawnSettings.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.PHANTOM, 1, 1, 2));
        spawnSettings.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EndEntities.SHADOW_WALKER.get(), 80, 2, 4));
...
//              .terrainHeight(0F)
    ...
    public static Biome IceStarfield() {
        MobSpawnSettings.Builder spawnSettings = new MobSpawnSettings.Builder();
        BiomeGenerationSettings.Builder generationSettings = new BiomeGenerationSettings.Builder();
        spawnSettings.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.ENDERMAN, 20, 1, 4));
        return new Biome.BiomeBuilder()
                .specialEffects((new BiomeSpecialEffects.Builder())
