...
import ru.betterend.bclib.interfaces.PatchBiFunction;
import ru.betterend.bclib.interfaces.PatchFunction;
...
public abstract class Patch {
	 ...
	 * {@link ru.betterend.bclib.api.WorldDataAPI} for this Mod.
	 * The function needs to return {@code true}, if changes were made to the data.
	 * If an error occurs, the method should throw a {@link PatchDidiFailException}
	 *
	 * The default implementation of this method returns null.
	...
	/**
	 * Returns a list of paths where your mod stores IDs in your {@link ru.betterend.bclib.api.WorldDataAPI}-File.
	 * <p>
	 ...
	 * <p>
	 * The end of the path can either be a {@link net.minecraft.nbt.StringTag}, a {@link ListTag} or
	 * a {@link CompoundTag}. If the Path contains a non-leaf {@link ListTag}, all members of that
	 ...
	 * or <i>inventory</i>-{@link ListTag} was found, the system will continue recursivley with
	 * every item of that list.
	 * <p>
	 * if the leaf-entry is a {@link ListTag}, it is handle the same as a child <i>items</i> entry
	 * of a {@link CompoundTag}.
	 * 
	 * @return {@code null} if nothing changes or a list of Paths in your {@link ru.betterend.bclib.api.WorldDataAPI}-File.
	 * Paths are dot-seperated (see {@link ru.betterend.bclib.api.WorldDataAPI#getCompoundTag(String, String)}).
	 */
