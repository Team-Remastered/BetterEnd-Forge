package ru.betterend.bclib.world.structures;
...
public class BCLStructureFeature {
	...
	/**
	 * Adds biome into internal biome list, used in {@link ru.betterend.bclib.api.biomes.BCLBiomeBuilder}.
	...
	/**
	 * Get biome list where this structure feature can generate. Only represents biomes made with {@link ru.betterend.bclib.api.biomes.BCLBiomeBuilder} and only
